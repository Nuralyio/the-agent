 ...
 */
interface ExecutionStreamClient {
 ...
 */
interface ExecutionStreamWithClients {
...
export class AutomationApiServer {
     ...
     */
    private broadcastCustomEvent(event: Record<string, unknown>): void {
        ...
        if (clients) {
            clients.forEach((client: ExecutionStreamClient) => {
                try {
